...
<div id="catebody">
	<div id="category">
		...
		<div class="title">
			...
			<a href="<?php echo $g['adm_href']?>&amp;iframe=<?php echo $iframe?>" title="확장게시판추가"><img src="<?php echo $g['img_core']?>/_public/btn_add.gif" alt="추가" /></a>
		...
		<?php else:?>
		<div class="none">등록된 확장게시판이 없습니다.</div>
		<?php endif?>
	...
	<div id="catinfo">
		...
		<div class="notice">
			확장게시판의 순서를 변경하려면 확장게시판을 드래그 후 [save]버튼을 클릭해 주세요.<br />
			확장게시판을 메뉴나 페이지에 연결하면 연결메뉴/연결페이지의 설정값은 무시됩니다.
		</div>
		...
		<table>
			<tr>
				...
				<td class="td2">
					...
					<?php if($R['id']):?>
					<span class="btn01"><a href="<?php echo RW('m='.$module.'&bid='.$R['id'])?>" target="_blank">확장게시판보기</a></span>
					<?php else:?>
					...
					<span class="b">확장게시판이름</span> : 확장게시판제목에 해당되며 한글,영문등 자유롭게 등록할 수 있습니다.<br />
			...
			<tr>
				...
				<td class="td2">
					...
					이 확장게시판을 메뉴에 연결하였을 경우 해당메뉴를 지정해 주세요.<br />
			...
			<tr>
				...
				<td class="td2 shift">
					...
					확장게시판에 더 많은 세부설정이 필요할 경우 사용합니다.<br />
		...
		<table>
			...
			<tr>
				...
				<td class="td2">
					...
					이 확장게시판에 대해서 관리자권한을 별도로 부여할 회원이 있을경우<br />
			...
			<tr>
				...
				<td class="td2">
					...
					이 확장게시판에 대해서 추가적인 정보가 필요할 경우 사용합니다.<br />
		...
		<div class="submitbox">
			<input type="submit" class="btnblue" value="<?php echo $R['uid']?'확장게시판속성 변경':'새확장게시판 만들기'?>" />
			<div class="clear"></div>
		</div>
