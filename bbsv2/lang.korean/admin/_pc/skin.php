...
<div id="catebody">
	...
	<div id="catinfo">
		...
		<div class="notice">
			...
			테마설정은 해당 테마를 사용하는 모든 확장게시판에 적용됩니다.
		</div>

		<ul>
		<li>테마는 확장게시판의 외형을 변경할 수 있는 요소입니다.</li>
		<li>테마설정은 확장게시판의 외형만 제어하며 게시판의 내부시스템에는 영향을 주지 않습니다.</li>
		<li>테마의 속성을 변경하면 해당테마를 사용하는 모든 확장게시판에 적용됩니다.</li>
		</ul>
