<?php
function getPostLinkv2($arr)
{
	return RW('m=bbsv2&bid='.$arr['bbsid'].'&uid='.$arr['uid'].($GLOBALS['s']!=$arr['site']?'&s='.$arr['site']:''));
}
...
<div id="bbslist">
	...
	<div class="sbox">
		...
		<option value="">등록된 확장게시판이 없습니다.</option>
		<?php endif?>
		</select>
	...
	<td class="sbj">
		...
		<a href="<?php echo getPostLinkv2($R)?>" target="_blank"><?php echo $R['subject']?></a>
