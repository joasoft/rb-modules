	...
	<table>
		<tr>
			...
			<td class="td2">
				...
				지정된 대표테마는 확장게시판설정시 별도의 테마지정없이 자동으로 적용됩니다.<br />
		...
		<tr>
			...
			<td class="td2">
				...
				통합보드란 모든 확장게시판의 전체 게시물을 하나의 게시판으로 출력해 주는 서비스입니다.<br />
		...
		<tr>
			...
			<td class="td2 shift">
				<input type="checkbox" name="rss" value="1"<?php if($d['bbs']['rss']):?> checked="checked"<?php endif?> />RSS발행을 허용합니다.(개별게시판별 RSS발행은 개별확장게시판 설정을 따름)<br />
			</td>
		</tr>
		<tr>
