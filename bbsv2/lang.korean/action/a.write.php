...
if (!$bid) getLink('','','확장게시판 아이디가 지정되지 않았습니다.','');
$B = getDbData($table[$m.'list'],"id='".$bid."'",'*');
if (!$B['uid']) getLink('','','존재하지 않는 확장게시판입니다.','');
...
if ($uid)
{
	...
	if ($reply == 'Y')
	{
		...
		$QKEY.= "hit,down,comment,oneline,trackback,score1,score2,singo,point1,point2,point3,point4,d_regis,d_modify,d_comment,d_trackback,upload,ip,agent,sns,add1,add2,add3,add4,add5,add6,add7,add8,add9,add10,add11,add12,add13,add14,add15,add16,add17,add18,add19,add20,add21,add22,add23,add24,add25,add26,add27,add28,add29,add30,add31,add32,add33,add34,add35,add36,add37,add38,add39,add40,add41,add42,add43,add44,add45,add46,add47,add48,add49,add50,adddata";
		$QVAL = "'$s','$gid','$bbsuid','$bbsid','$depth','$parentmbr','$display','$hidden','$notice','$name','$nic','$mbruid','$id','$pw','$category','$subject','$content','$html','$tag',";
		$QVAL.= "'0','0','0','0','0','0','0','0','$point1','$point2','$point3','$point4','$d_regis','','','','$upload','$ip','$agent','','$add1','$add2','$add3','$add4','$add5','$add6','$add7','$add8','$add9','$add10','$add11','$add12','$add13','$add14','$add15','$add16','$add17','$add18','$add19','$add20','$add21','$add22','$add23','$add24','$add25','$add26','$add27','$add28','$add29','$add30','$add31','$add32','$add33','$add34','$add35','$add36','$add37','$add38','$add39','$add40','$add41','$add42','$add43','$add44','$add45','$add46','$add47','$add48','$add49','$add50','$adddata'";
	...
	{	
		...
		$QVAL = "display='$display',hidden='$hidden',notice='$notice',pw='$pw',category='$category',subject='$subject',content='$content',html='$html',tag='$tag',point3='$point3',point4='$point4',d_modify='$d_regis',upload='$upload',add1='$add1',add2='$add2',add3='$add3',add4='$add4',add5='$add5',add6='$add6',add7='$add7',add8='$add8',add9='$add9',add10='$add10',add11='$add11',add12='$add12',add13='$add13',add14='$add14',add15='$add15',add16='$add16',add17='$add17',add18='$add18',add19='$add19',add20='$add20',add21='$add21',add22='$add22',add23='$add23',add24='$add24',add25='$add25',add26='$add26',add27='$add27',add28='$add28',add29='$add29',add30='$add30',add31='$add31',add32='$add32',add33='$add33',add34='$add34',add35='$add35',add36='$add36',add37='$add37',add38='$add38',add39='$add39',add40='$add40',add41='$add41',add42='$add42',add43='$add43',add44='$add44',add45='$add45',add46='$add46',add47='$add47',add48='$add48',add49='$add49',add50='$add50',adddata='$adddata'";
