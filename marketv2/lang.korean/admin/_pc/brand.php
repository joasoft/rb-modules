...
$marketData = getUrlData($d['marketv2']['url'].'&iframe=Y&page=client.brand&_clientu='.$g['s'].'&_clientr='.$r.'&sort='.$sort.'&orderby='.$orderby.'&type='.$type.'&p='.$p.'&where='.$where.'&keyword='.$keyword.'&id='.$d['marketv2']['id'].'&pw='.$d['marketv2']['pw'],10);
